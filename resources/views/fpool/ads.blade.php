                ...
                @slot('body')
                    <form action="{{ route('admin.ad.store') }}" method="POST">
                        ...
                        <div class="form-group col-lg-12">
                            <label for="mobile_ad">Mobile</label>
