    ...
    <div class="row col-12">
        <div class="col-lg-6 col-md-12">
            ...
            <div class="row">
                ...
                <div class="form-group col-lg-6">
                    <label
                        for="google_analytics">{{__('page.admin.settings.cards.website.website.google_analytics_id')}}</label>
            ...
            <div class="row">
                <div class="form-group col-lg-6">
                    ...
                    <div class="small text-muted">
                        {{__('page.admin.settings.cards.website.website.max_file_size_default')}}</div>
                </div>
                <div class="form-group col-lg-6">
                    <label
                        for="one_time_uploads">{{__('page.admin.settings.cards.website.website.one_time_uploads')}}</label>
            ...
            <div class="row">
                ...
                <div class="form-group col-lg-6">
                    ...
                    <div class="small text-muted">
                        {{__('page.admin.settings.cards.website.website.theme_color_default')}}</div>
                </div>
                <div class="form-group col-lg-6">
                    <label
                        for="uploads_storage">{{__('page.admin.settings.cards.website.website.uploads_storage')}}</label>
                    ...
                    <div class="small font-italic">
                        {{__('page.admin.settings.cards.website.website.uploads_storage_default')}}</div>
                </div>
            </div>
        ...
        <div class="col-lg-6 col-md-12">
            ...
            <div class="form-group">
                <label
                    for="browse_text">{{__('page.admin.settings.cards.website.dropzone.browse_attribute_text')}}</label>
            ...
            <div class="form-group">
                ...
                <div class="small text-muted">{{__('page.admin.settings.cards.website.dropzone.rule_text_default')}}
                </div>
            </div>
        </div>
    </div>
